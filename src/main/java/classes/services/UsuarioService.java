...
public class UsuarioService {
	...
	public String trocarSenha(String idLogado, String senhaAtual, String senhaNova, String senhaConfirmar) {
		
		//ResultSet rs = usuario.buscarPorEmail(email);
		Usuario tempUser = new Usuario();
		String message = "";
		
//		tempUser.buscarPorId(idLogado);
//		rs.next();
//
//		String userPassword = rs.getString("senha");
//		
//		if(!(userPassword.equals(senhaAtual))) {
//			message = "401 Usuário ou senha incorretos.";
//		}
//		else {
//			
//			message = "Senha altrerada com sucesso.";
//			usuario.trocar("senha", senhaNova, idLogado);
//		}			
		return message;
	}
}
